...
definePageMeta({
  ...
  validate ({ params }) {
    ...
    return simulateurs.includes(params.simulateur_id as string)
  }
})
...
/**
 * @todo Replace this with real data returned by the API
 */
const rawAides: RawAide[] = [
  {
    id: 'aide-1',
    eligibilite: true,
    montant: 1000,
...
const richResults = transformSimulationResults(rawAides, simulateurId)
